...
<body>
<form class="form-horizontal" modelAttribute="voiture">
<fieldset>
...
<div class="control-group">
  <label disabled="disabled" class="control-label" for="IdVoiture">Id</label>
  <div class="controls">
    <form:input id="IdVoiture" name="IdVoiture" placeholder="" class="input-xlarge" type="text" path="id"/>
...
<div class="control-group">
  ...
  <div class="controls">
    <form:input  disabled="disabled" id="ImmatriculationVehicule" name="ImmatriculationVehicule" placeholder="" class="input-xlarge" type="text" path="immatriculation"/>
